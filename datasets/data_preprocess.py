            ...
            for region in data[i]['regions']:
                ...
                if class_name =="Text" or class_name =="text":
                    if region['shape_attributes']['name'] =='rect':
                        x,y,weight,height = region['shape_attributes']['x'],region['shape_attributes']['y'],region['shape_attributes']['width'],region['shape_attributes']['height']
                        ...
                        x,y,weight,height = min(all_x), min(all_y), max(all_x), max(all_y)
